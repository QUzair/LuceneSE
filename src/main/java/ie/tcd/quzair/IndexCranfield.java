...
public class IndexCranfield
{
    ...
    private static String INDEX_DIRECTORY = "./cran_index_posting";

    private Analyzer analyzer;
    private Directory directory;

    public IndexCranfield() throws IOException
    {
    ...
    public void buildIndex(String[] args) throws IOException
    {
        ...
        for (String arg : args)
        {
            ...
            String content = new String(Files.readAllBytes(Paths.get("../corpus/"+arg)));
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        File aDirectory = new File("../corpus");
        File cranDirectory = new File("./resources/cran/cran.all.1400");
        ...
        IndexCranfield qi = new IndexCranfield();
        qi.buildIndex(args);
        qi.postingsDemo();
        qi.shutdown();
    }
